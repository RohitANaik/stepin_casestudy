 ...
 * @brief To pass the read value to the oscilloscope
 * @version 0.1
 * @date 2021-09-16
 * 
...
#include "activity4.h"
/**
 * @brief initializing the USART port
 * 
 */
void Init_USART()
{
...
/**
 * @brief reading the values in USART port
 * 
 * @return int UDR0 values
 */
int Read_USART()
{
    while(!(UCSR0A &(1<<RXC0)))
...
/**
 * @brief writing the read value into the oscilloscope
 * 
 * @param temp the ADC value that is read
 */
